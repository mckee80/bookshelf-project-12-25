...
const mockBackend = {
  users: [
    { id: 1, email: 'demo@example.com', password: 'demo123', name: 'Demo User', subscription: 'premium', downloads: [1, 3] }
  ],
  ebooks: [
    { id: 1, title: 'The Art of Digital Minimalism', author: 'Sarah Chen', cover: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400&h=600&fit=crop', description: 'Discover the principles of living intentionally in a digital world', pages: 240, premium: false },
    { id: 2, title: 'Modern Typography Handbook', author: 'Marcus Webb', cover: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=400&h=600&fit=crop', description: 'A comprehensive guide to contemporary type design', pages: 320, premium: false },
    { id: 3, title: 'Code & Consciousness', author: 'Alex Rivera', cover: 'https://images.unsplash.com/photo-1589998059171-988d887df646?w=400&h=600&fit=crop', description: 'Exploring the philosophy of software development', pages: 280, premium: true },
    { id: 4, title: 'Visual Storytelling', author: 'Nina Patel', cover: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=400&h=600&fit=crop', description: 'The power of narrative through design', pages: 195, premium: true },
  ],
  products: [
...
export default function EbookStore() {
  ...
  const handleDownload = (ebookId) => {
    ...
    if (ebook.premium && currentUser.subscription === 'free') {
      alert('This ebook requires a Premium subscription!');
    ...
    <div className="home-view">
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">
            <span className="hero-title-main">Digital Library</span>
            <span className="hero-title-sub">for Modern Readers</span>
          </h1>
          <p className="hero-description">
            Access premium ebooks, support creators through monthly contributions,
            and express your love for reading with our curated merchandise.
          </p>
          <div className="hero-actions">
            <button className="btn btn-primary" onClick={() => setActiveView('ebooks')}>
              Browse Library
            </button>
            <button className="btn btn-secondary" onClick={() => setActiveView('shop')}>
              Visit Shop
            </button>
          </div>
        </div>
      ...
      <section className="features">
        <div className="feature">
          ...
          <p>Carefully curated collection of digital books across various genres</p>
        </div>
        <div className="feature">
          <div className="feature-icon"><Heart /></div>
          <h3>Support Creators</h3>
          <p>Monthly contributions help us bring you more quality content</p>
        </div>
        <div className="feature">
          <div className="feature-icon"><ShoppingBag /></div>
          <h3>Exclusive Merch</h3>
          <p>T-shirts, stickers, and more to celebrate your reading journey</p>
        </div>
      </section>
    </div>
  );
  ...
  const EbooksView = () => (
    <div className="ebooks-view">
      <div className="view-header">
        <h2>Ebook Library</h2>
        <p>Download and read unlimited books with your membership</p>
      </div>
        ...
        {mockBackend.ebooks.map(ebook => (
          <div key={ebook.id} className="ebook-card">
            <div className="ebook-cover">
              ...
              {ebook.premium && <span className="badge-premium">Premium</span>}
  ...
  const ShopView = () => (
    <div className="shop-view">
      <div className="view-header">
        ...
        <p>Wear your love for reading</p>
      </div>
  ...
  const SubscriptionView = () => (
    <div className="subscription-view">
      <div className="view-header">
        ...
        <p>Support us and get access to premium content</p>
      </div>
      <div className="pricing-cards">
        <div className="pricing-card">
          ...
          <ul className="features-list">
            <li><Check size={16} /> Access to free ebooks</li>
            <li><Check size={16} /> Shop merchandise</li>
            <li><Check size={16} /> Community access</li>
          </ul>
          <button className="btn btn-secondary" disabled={!currentUser || currentUser.subscription === 'free'}>
            {currentUser?.subscription === 'free' ? 'Current Plan' : 'Select'}
          </button>
        </div>
        ...
        <div className="pricing-card featured">
          ...
          <ul className="features-list">
            ...
            <li><Check size={16} /> Access to premium ebooks</li>
            <li><Check size={16} /> Early access to new releases</li>
            <li><Check size={16} /> 15% discount on merchandise</li>
          ...
          >
            {currentUser?.subscription === 'premium' ? 'Current Plan' : 'Upgrade Now'}
          </button>
        </div>
        ...
        <div className="pricing-card">
          ...
          <ul className="features-list">
            <li><Check size={16} /> All premium features</li>
            <li><Check size={16} /> Exclusive supporter badge</li>
            <li><Check size={16} /> Monthly bonus content</li>
            <li><Check size={16} /> 25% discount on merchandise</li>
